  ...
  return (
    <>
      <div className="container mx-auto xl:pl-2">
        ...
        <div className="mb-32 grid grid-cols-2 border-t-0 border-[#777572] sm:grid-cols-2 lg:grid-cols-4 lg:border-t-2">
            ...
            <div className="mt-8 space-y-6">
              ...
              <div className="pb-0">
                <p className="plain-regular pb-12 text-[1.1rem] text-[#2d2d2d]">
                  ...
                  historians who share their perspectiveson the traditions and
