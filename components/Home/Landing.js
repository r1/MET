...
export default function Landing() {
  return (
    <>
      <div className="mx-auto flex max-w-7xl flex-col items-center justify-center px-5 py-24">
        <div className="relative flex justify-center">
          <div className="z-0 grid pr-44 pl-12">
            <div className="pos-1 hidden lg:grid">
              <div className="relative h-[7.7rem] w-24 bg-[url('/images/Iyoba.jfif')] bg-cover" />
            </div>
            ...
            <div className="pos-3 hidden lg:grid">
              <div className="relative h-40 w-32 bg-[url('/images/Pieta.jfif')] bg-cover" />
            </div>
          ...
          <div className="z-40 w-full text-left lg:text-center">
            ...
            <div className="plain-medium ml-0 mt-14 flex justify-start text-left lg:ml-72 lg:justify-center">
              <div className="flex flex-col">
                ...
                <a href="/" className="text-[#ec0426] inline-block">
